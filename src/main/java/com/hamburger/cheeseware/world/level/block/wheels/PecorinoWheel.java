...
public class PecorinoWheel extends AbstractCheeseWheelBlock {
    public PecorinoWheel(Properties properties) {
        super(properties);
    }
    ...
    protected InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hitResult) {
        ...
        if (!level.isClientSide) {
            if (leftovers < 3) {
                ...
                player.getInventory().add(CWItems.PECORINO_CHEESE.toStack());
            } else {
